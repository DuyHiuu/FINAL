                            ...
                            <div className="space-y-2">
                                {vouchers
                                    ...
                                    .map((voucher) => {
                                        ...
                                        const checkMax = total_amount > voucher.max_total_amount;
                                                    ...
                                                    <div className="flex flex-col text-red-500 text-sm ml-2">
                                                        {checkMin && (
                                                            <div className="flex items-center space-x-1">
                                                                ...
                                                                <span>
                                                                    Yêu cầu tối thiểu: {voucher.min_total_amount.toLocaleString()} VNĐ
                                                                </span>
                                                            </div>
                                                        )}
                                                        {checkMax && (
                                                            <div className="flex items-center space-x-1">
                                                                ...
                                                                <span>
                                                                    Yêu cầu tối đa: {voucher.max_total_amount.toLocaleString()} VNĐ
                                                                </span>
                                                            </div>
                                                        )}
                                                    </div>
