                            ...
                            <div className="max-w-md">
                                <div className="grid grid-cols-1 gap-6">
                                    ...
                                    <label className="block">
                                        ...
                                        <textarea className="mt-1 block w-full rounded-md bg-gray-100 border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 p-2" rows='3'></textarea>
                                    </label>
                                    <label className="block">
                        ...
                        <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
                            ...
                            <center>
                                <button className="text-white px-10 py-2 rounded-full bg-[#064749]">
                                    <a href="/history">Lịch sử đặt phòng</a>
                                </button>
                            </center>
                        </div>
                    </div>
