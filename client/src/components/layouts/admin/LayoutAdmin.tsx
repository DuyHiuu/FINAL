...
const navigationItems = [
  { name: "PestSpa", href: "/admin", current: false },
  ...
  { name: "Quản lý Blog", href: "/admin/blogs", current: false },
...
const LayoutAdmin = () => {
  ...
  // Cập nhật trạng thái 'current' dựa trên đường dẫn hiện tại
                    ...
                    {navigation.map((item) => (
                      <Link
                        ...
                        className={classNames(
                          ...
                          "whitespace-nowrap rounded-md px-2 py-2 text-xs font-medium" // Giảm padding và kích thước chữ
                        )}
                      >
                        {item.name}
                      </Link>
